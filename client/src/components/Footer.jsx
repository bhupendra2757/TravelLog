...
function Footer() {
    return (
        <footer className="relative flex flex-col items-center overflow-hidden bg-orange-500 dark:bg-orange-900 py-20 md:py-40">
            <div className="container relative z-[1] m-auto px-6 md:px-12">
                <div className="m-auto md:w-10/12 lg:w-8/12 xl:w-6/12">
                    <div className="flex flex-wrap items-center justify-between md:flex-nowrap">
                        <div className="flex w-full justify-center space-x-12 text-gray-600 dark:text-gray-100 sm:w-7/12 md:justify-start">
                            <ul className="list-inside list-disc space-y-5">
                                ...
                                <li><a href="#" className="transition hover:text-primary">Blogs</a></li>
                        ...
                        <div className="m-auto mt-16 w-10/12 space-y-6 text-center sm:mt-auto sm:w-5/12 sm:text-left">
                            <span className="block text-gray-500 dark:text-gray-300"> Get Retired With Loads of Memories. </span>
                            <span className="block text-gray-500 dark:text-gray-400"><span id="year" /></span>
                            <span className="block text-gray-500 dark:text-gray-300">Need help? <a href="#" className="font-semibold text-white"> Contact Us</a></span>
                        </div>
                    </div>
                </div>
            </div>
