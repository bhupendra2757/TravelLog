...
export default function HomeContent() {
    return (
        <>
            <div className="bg-[url('../src/assets/banner.jpg')] pb-8 bg-cover h-[50vh]">
            ...
            <div className="flex flex-row justify-around items-center pt-4">
                ...
                <div>
                    <div className="bg-red-900 h-[150px] w-[300px]">
                    </div>
                </div>
            </div>
            <div className="flex flex-row justify-around items-center pt-4">
            ...
            <footer>
                <div className="mt-5 h-[20vh] bg-red-900 flex justify-center items-center">
