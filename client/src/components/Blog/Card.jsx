...
export default function Card(props) {
    ...
    return (
        <>
            <section className="flex flex-col justify-center antialiased bg-gray-900 text-gray-200 p-10">
                    ...
                    <article className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
                        ...
                        <div>
                            ...
                            <footer className="flex items-center mt-4">
                                ...
                                <div>
                                    <a className="font-medium text-gray-200 hover:text-gray-100 transition duration-150 ease-in-out" href="#0">{props.blogger}</a>
