        ...
        <>
            <div className="bg-[url('../src/assets/banner.jpg')] pb-8 bg-cover h-[100vh] " >
                <div className="container flex flex-col justify-between gap-y-10 text-center text-white py-[10em]">
                    ...
                    <div className='py-20'>
                        <a href="/blog" className="mx-auto block w-max text-white sm:text-xl md:text-3xl lg:text-center xl:text-4xl hover:bg-gradient-to-r from-pink-400 to-orange-600 font-semibold hover:text-white py-2 px-4 border border-white hover:border-transparent rounded transition duration-700"> Start &nbsp; Now</a>
                    </div>
                </div>
            </div >
            <Blog/>
